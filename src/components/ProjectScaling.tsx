            ...
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto text-center mb-20">
                    <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 uppercase tracking-tight">
                        МАСШТАБИРОВАНИЕ <span className="text-neon-orange italic">БЕЗ ГРАНИЦ</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
                    ...
                    <div className="hidden lg:block absolute top-1/2 left-0 w-full h-[1px] bg-gradient-to-r from-neon-cyan/20 via-neon-orange/20 to-neon-cyan/20 -translate-y-1/2 z-0" />
                    ...
                    {scalingSteps.map((step, index) => (
                        <motion.div
                            ...
                            className="relative z-10 bg-white/[0.03] border border-white/10 p-8 rounded-[2rem] hover:border-neon-orange/40 transition-all duration-500 group"
                        >
                            ...
                            <h3 className="text-lg font-black text-white mb-2 tracking-tight group-hover:text-neon-orange transition-colors">{step.title}</h3>
                            <div className="text-neon-cyan font-bold text-sm mb-4 tracking-widest">{step.price}</div>
                ...
                <div className="mt-20 p-10 rounded-[3rem] bg-gradient-to-br from-white/[0.03] to-transparent border border-white/5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="space-y-3">
                            <div className="text-neon-orange font-black text-2xl">01</div>
                        ...
                        <div className="space-y-3">
                            <div className="text-neon-orange font-black text-2xl">02</div>
                        ...
                        <div className="space-y-3">
                            <div className="text-neon-orange font-black text-2xl">03</div>
